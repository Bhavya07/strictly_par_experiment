...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { CGPA: @education.CGPA, Institute: @education.Institute, Percentage: @education.Percentage, Year: @education.Year, degree: @education.degree }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { CGPA: @education.CGPA, Institute: @education.Institute, Percentage: @education.Percentage, Year: @education.Year, degree: @education.degree }
    assert_redirected_to education_path(assigns(:education))
  end
